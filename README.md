<h1 align="center">
  <img src="https://dashboard.snapcraft.io/site_media/appmedia/2017/04/storj.png" alt="Storj Share GUI">
  <br />
  Storj Share GUI
</h1>
...
## Install
    ...
    sudo snap install storjshare-gui --beta

([Don't have snapd installed?](https://snapcraft.io/docs/core/install))

<!--
![Storj Share GUI](screenshot.png?raw=true "Storj Share GUI")
-->
...
upstream so Storj Share GUI can authoritatively publish future releases.
  ...
  - [x] Submit a pull request or patch upstream that adds snap install documentation - [link](https://github.com/Storj/storjshare-gui/pull/542)
